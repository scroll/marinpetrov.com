...
Right now I'm building [Coliven](https://coliven.com), which I develop and own. Coliven is for people who gather in real life—and for the hosts who make those gatherings happen.

For members and explorers, it's a place to discover intentional communities, retreat centers, event brands, and local groups. For hosts, it's one operating platform: a public community page worth sharing, event management, ticketing, and membership payments—so the energy that goes into running a community actually goes into the community. We're not a room-booking coliving marketplace. Coliven is built for the relationship between host and community over time.

I built it because the tools hosts use today weren't made for this work. Luma is great for getting people to show up; it has little idea what happens next. Patreon works for creators who already have an audience; most hosts are still building theirs. Notion is endlessly flexible, which often means endlessly unfinished. None of these are bad choices. They just weren't built for someone running a retreat, a weekly gathering, or an intentional space. Hosts end up doing invisible work to fill the gaps—and still can't point anyone to one place that shows who they are and what they offer. That's the gap Coliven was built for.

Coliven is for hosts who gather people in person: intentional communities, ecovillages, retreat centers, recurring event series, pop-up cities, neighborhood groups, and online communities with regular in-person gatherings. My intention is simple: help hosts build healthier economics around that work, so this kind of leadership can be sustainable instead of something you do despite the circumstances.
